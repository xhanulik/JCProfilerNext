 ...
 */
public class ModifyPowerEntryPointProcessor extends AbstractModifyEntryPointProcessor {
    /**
     * Constructs the {@link ModifyPowerEntryPointProcessor} class.
     *
     * @param args object with commandline arguments
     */
    public ModifyPowerEntryPointProcessor(final Args args) {
        super(args);
    }
